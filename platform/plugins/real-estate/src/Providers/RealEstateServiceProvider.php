...
class RealEstateServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->app->afterResolving(Schedule::class, function (Schedule $schedule): void {
            ...
            // Process saved search alerts daily
            $schedule
                ->command('real-estate:process-saved-search-alerts --frequency=daily')
                ->dailyAt('09:00');
            
            // Process saved search alerts weekly
            $schedule
                ->command('real-estate:process-saved-search-alerts --frequency=weekly')
                ->weeklyOn(1, '09:00'); // Monday at 9 AM
            
            // Sync Nigerian properties daily
            $schedule
                ->command('real-estate:sync-nigerian-properties')
                ->dailyAt('02:00');
        });
